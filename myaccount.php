...
if(file_exists('addons/getmycontacts/index.php')) $powertool_invitemycontacts = 1;

//check for subscription
if(file_exists('/addons/subscriptionmanager/license_sm.php')) $powertool_subscription = 1;
