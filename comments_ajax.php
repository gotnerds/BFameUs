...
while ($result = @mysql_fetch_array($query)) {
	...
	$drop_block = "<div id=\"drop_block_$indexer_id\"></div>";
    	...
    	$video_comment_edit_on = '<a href="edit/editcomments.php?type=1&id='.$indexer_id.'" title="Edit" onclick="return parent.GB_show(\'Edit Comment\', this.href, 400, 700)">
    	...
    	$video_comment_delete_on = '<a href="edit/delete.php?type=19&id='.$indexer_id.'" title="Delete" onclick="return parent.GB_show(\'Delete Comment\', this.href, 300, 700)">
	...
	////////////////////////////////////////////////////////////////////////////////////
	// we need to query videocomments_replys to find any REPLIES
	...
	while ($result_replies = @mysql_fetch_array($replies)) {
		...
		if ( $reply_delete_on == 1 ) {
			$delete_reply_on = "<div style=\"margin-right:12px; float:right;\">
			  <a href=\"edit/delete.php?type=14&id=$reply_id\" title=\"$lang_delete_general\" onclick=\"return parent.GB_show('Delete Reply', this.href, 350, 550)\">
		...
		if ( $reply_edit_on == 1 ) {
			$edit_reply_on = "<div style=\"margin-right:12px; float:right;\">
			  <a href=\"edit/editcomments.php?type=2&id=$reply_id\" title=\"$lang_edit\" onclick=\"return parent.GB_show('Edit Reply', this.href, 350, 550)\">
...
$template = "themes/$user_theme/templates/inner_comments_ajax.htm";
